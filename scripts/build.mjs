...
const sharedCSS=['src/foundations.css','src/components.css','src/patterns/specimen.css'].map(read).join('\n');
...
write('_headers','/*\n  Cache-Control: no-transform\n  X-Content-Type-Options: nosniff\n  Referrer-Policy: strict-origin-when-cross-origin\n  Content-Security-Policy: default-src \'self\'; script-src \'self\' \'unsafe-inline\'; style-src \'self\' \'unsafe-inline\'; img-src \'self\' data: blob:; connect-src \'self\'; font-src \'self\'; form-action \'none\'; frame-ancestors \'none\'; object-src \'none\'; base-uri \'self\'\n');
